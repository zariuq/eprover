...
void WatchlistRemoveRewritables(WatchlistControl_p watchlist, ClauseSet_p rws,
   OCB_p ocb, ClauseSet_p archive, Clause_p clause);

void WatchlistInsertRewritten(WatchlistControl_p watchlist, ClauseSet_p rws, 
